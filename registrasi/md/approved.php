      ...
      <div class="templatemo-content-wrapper">
	   ...
	   !-->
		...
		<?php
			...
			db_connect();
			$sqlsel  = "SELECT id,nama,ambisimu,deskripsi,url,image,alasan,socmeduser FROM ambuser ";
			$sqlsel .= "WHERE moderate=1 ORDER by datetime ASC LIMIT 0,100";
		...
		?>
		  <!-- While !-->
			...
			<?php echo $alasan;?>
				...
				//$socmeduser = "azisaz";
				$twtext	    = urlencode("Hae apa kabar");
				$urltwitter .= "text=".$twtext."&url=".urlencode($url)."&hashtags=Ambisiku&via=".$socmeduser;

				$urlfacebook = "https://www.facebook.com/sharer/sharer.php?u=".urlencode($url);
				$urlgoogle = "https://plus.google.com/share?url=".urlencode($url);
			    ?>
                            <li><a target="popup" onclick="window.open('<?php echo $urltwitter;?>','name','width=550,height=420')">Share to Twitter</a></li>
                            <li><a target="popup" onclick="window.open('<?php echo $urlfacebook;?>','name','width=550,height=420')">Share to Facebook</a></li>
                            <!--<li><a target="popup" onclick="window.open('<?php echo $urlgoogle;?>','name','width=550,height=420')">Share to Google+</a></li>!-->
                            <li><a href="?s=dismiss&id=<?php echo $id;?>">Dismiss</a></li>
                          </ul>
                        </div>
                      </td>
                    </tr>
